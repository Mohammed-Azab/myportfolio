    ...
    honorsAndAwards: [
      {
        ...
        date: "2024",
        description: "Recognized for outstanding academic performance with GPA above 3.8 for 6 consecutive semesters"
      },
      {
        title: "Best Final Year Project Award",
        organization: "Mechatronics Department",
        date: "2024",
        description: "Awarded for innovative AI-powered prosthetic device development project"
      },
      {
        title: "Academic Excellence Scholarship",
        organization: "German International University",
        date: "2022-2025",
        description: "Merit-based scholarship covering 50% tuition fees for outstanding academic performance"
      },
      {
        title: "Outstanding Student in Robotics",
        organization: "Robotics Department",
        date: "2023",
        description: "Recognition for exceptional performance in robotics coursework and laboratory projects"
      },
      {
        title: "Research Assistant Excellence Award",
        organization: "AI Research Lab",
        date: "2024",
        description: "Acknowledged for significant contributions to prosthetic device research project"
      }
    ],
    ...
    volunteering: [
      {
        ...
        description: "Mentor high school students in robotics and programming, organizing weekly workshops and competition preparation",
        impact: "Mentored 25+ students, with 80% advancing to regional robotics competitions"
      },
      {
        role: "Technical Workshop Leader",
        organization: "Maker Space Berlin",
        duration: "Jan 2023 - Aug 2023",
        description: "Led hands-on workshops on Arduino programming, 3D printing, and basic electronics for community members",
        impact: "Conducted 15+ workshops with 200+ participants from diverse backgrounds"
      },
      {
        role: "Peer Tutor",
        organization: "University Academic Support Center",
        duration: "Oct 2022 - Dec 2022",
        description: "Provided tutoring in mathematics, physics, and programming fundamentals to first-year engineering students",
      ...
      },
      {
        ...
        description: "Led university robotics club, organized competitions, managed budget, and coordinated with industry partners",
        impact: "Increased club membership by 150% and secured €5,000 in sponsorships"
      }
    ]
  },
  {
    ...
    honorsAndAwards: [
      {
        ...
        date: "2021",
        description: "Graduated as top student with highest GPA in the engineering preparatory program"
      },
      {
    ...
    volunteering: [
      {
        ...
        description: "Tutored underprivileged students in mathematics and physics preparation for university entrance exams",
        impact: "Helped 20+ students achieve 90%+ scores in entrance examinations"
      },
      {
        role: "Science Club Vice President",
        organization: "GUC Science Society",
        duration: "Sep 2019 - Jun 2021",
        description: "Organized science exhibitions, coordinated guest lectures, and managed club activities",
        impact: "Increased club participation by 200% and organized 5 major science events"
      }
    ]
  }
];
